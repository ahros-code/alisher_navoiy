            ...
            >
              <CarouselContent>
                {data?.data?.map((item: any, index: any) => (
                  <CarouselItem
                    key={index}
                    className="pr-5 basis-full lg:basis-2/6 cursor-pointer"
                  >
                    <div className="bg-gray-100 relative shadow-xl overflow-hidden hover:shadow-2xl group rounded-xl p-5 transition-all duration-500 transform">
                      <div className="grid grid-cols-6  gap-4 items-center">
                        ...
                        <div className=" col-span-4 w-fit transition-all transform duration-500">
                          ...
                          <p className="  text-sm md:text-base text-gray-500 transform transition-all delay-300 duration-500">
                            {item.role && (
                              <span className="text-maincolor inline-block">
                                {" "}
                                <span className="text-gray-700">
                                  {item.role.length > 100
                                    ? item.role.substring(0, 100) + "..."
                                    : item.role}
                                </span>
                              </span>
                            )}
